...
// Placeholder links - update with your actual URLs
    ...
    <div class="container">
      ...
      <div class="contact__links">
        ...
        >
          ...
          <span class="contact__link-name">{{ link.name }}</span>
        </a>
      </div>

      <footer class="footer">
        <p>Designed & Built by <span class="text-gradient">Sreeni</span></p>
        <p class="footer__copyright">&copy; {{ new Date().getFullYear() }} All rights reserved.</p>
      </footer>
    </div>
  </section>
</template>
